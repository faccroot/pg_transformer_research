...
SCRIPT="$ROOT/tools/representation_learning/verify_model_stitching_layer_sweep.py"
...
exec "$DISPATCH" "${HOST_ARGS[@]}" \
  ...
  --requirements \
  "$REQUIREMENTS" \
  "$ROOT/tools/representation_learning/compare_gcca_stitching.py" \
  "$ROOT/tools/representation_learning/verify_model_stitching.py" \
  "$ROOT/tools/representation_learning/verify_model_stitching_cohort.py" \
  "$ROOT/tools/representation_learning/verify_model_stitching_layer_sweep.py" \
